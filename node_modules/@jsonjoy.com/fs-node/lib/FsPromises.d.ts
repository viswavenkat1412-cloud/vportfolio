...
export declare class FsPromises implements FsPromisesApi {
    ...
    readonly cp: (src: string | URL, dest: string | URL, options?: opts.ICpOptions) => Promise<void>;
    readonly copyFile: (src: misc.PathLike, dest: misc.PathLike, mode?: number) => Promise<void>;
    readonly opendir: (...args: any[]) => Promise<any>;
    readonly statfs: (...args: any[]) => Promise<any>;
    readonly lutimes: (...args: any[]) => Promise<any>;
    readonly glob: (pattern: string | string[], options?: opts.IGlobOptions) => AsyncGenerator<string | import("./Dirent").Dirent, any, any>;
