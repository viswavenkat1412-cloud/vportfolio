...
export declare class Superblock {
    ...
    walk(steps: string[], resolveSymlinks: boolean, checkExistence: boolean, checkAccess: boolean, funcName?: string, budget?: {
        hops: number;
    }): Result<Link | null, StatError>;
    walk(filename: string, resolveSymlinks: boolean, checkExistence: boolean, checkAccess: boolean, funcName?: string, budget?: {
        hops: number;
    }): Result<Link | null, StatError>;
    walk(link: Link, resolveSymlinks: boolean, checkExistence: boolean, checkAccess: boolean, funcName?: string, budget?: {
        hops: number;
    }): Result<Link | null, StatError>;
    walk(stepsOrFilenameOrLink: string[] | string | Link, resolveSymlinks: boolean, checkExistence: boolean, checkAccess: boolean, funcName?: string, budget?: {
        hops: number;
    }): Result<Link | null, StatError>;
    ...
    openLink(link: Link, flagsNum: number, resolveSymlinks?: boolean, filename?: string): File;
    private throwCreatDir;
